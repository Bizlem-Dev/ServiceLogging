					...
					<div class="row">
						...
						<div class="bs-example bs-example-tabs"  style="height:500px; display: flex; flex-direction: column;border-radius: 15px: ">
					      <ul id="myTab" class="nav nav-tabs" style="flex: 0 0 auto">
					        ...
					        <li class=""><a href="#customer" data-toggle="tab"> Customer(<%=cvCount %>)</a></li>
					       <li class=""><a href="#vendor" data-toggle="tab"> Vendor(<%=vendorItemCount %>)</a></li>
					      </ul>
					    <div class="tab-content">
<!-- tab content start here and start of 1st tab-->
							 ...
							 <div style="height: 300px;overflow: auto;">
							 	<table id="mytable1" class="table table-bordred table-striped table-fixed">
							 ...
							 <div style="height: 300px;overflow: auto;">
							 	<table id="mytable2" class="table table-bordred table-striped table-fixed">
							 ...
							 <h4 class="text-center">Partially Matched Records</h4>
														 <div style="height: 300px;overflow: auto;">
							 	<table id="mytable3" class="table table-bordred table-striped table-fixed">
	...
	<!--Product tab content starts here -->
							...
							//	out.print(jsonProdRes);
								...
								//	 out.print(prodJson.getJSONArray("matchedinfo"));
								//	 out.print(prodJson.getJSONArray("unmatchedinfo"));
								//	 out.print(prodJson.getJSONArray("partmatchedinfo"));
							...
							//	out.print(comparray);
							 ...
							 <div style="height: 300px;overflow: auto;">
							 	<table id="mytable4" class="table table-bordred table-striped table-fixed">
								   ...
								   <% for(int k=0;k<prodarray.length();k++){%>
								    <tr>
								    <td><input type="checkbox" class="checkthis" value="<%=prodarray.getJSONObject(k).getString("id") %>" /></td>
								    <td><input type="text" value="<%=prodarray.getJSONObject(k).getString("category") %>" name="matcat" /></td>
								    <td><input type="text" value="<%=prodarray.getJSONObject(k).getString("id") %>" name="matprod" /></td>
								    <td><input type="text" value="<%=prodarray.getJSONObject(k).getString("shortdesc") %>" name="matshortdesc" /></td>
								    <td><input type="text" value="<%=prodarray.getJSONObject(k).getString("image") %>" name="matimage" /></td>
								    <td><input type="text" value="<%=prodarray.getJSONObject(k).getString("productname") %>" name="matprodname" /></td>
								    <td><input type="text" value="<%=prodarray.getJSONObject(k).getString("modelnumber") %>" name="matmodelnumber" /></td>
								    <td><input type="text" value="<%=prodarray.getJSONObject(k).getString("companyname") %>" name="matmanu" /></td>
								    </tr>
								<%} %>
								   </tbody>
							 ...
							 <div style="height: 300px;overflow: auto;">
							 	<table id="mytable5" class="table table-bordred table-striped table-fixed">
								    ...
								    <tr>
								    <td><input type="checkbox" class="checkthis" value="<%=prodarrayUn.getJSONObject(k).getString("id") %>" /></td>
								    <td><input type="text" value="<%=prodarrayUn.getJSONObject(k).getString("category") %>" name="unmatcat" /></td>
								    <td><input type="text" value="<%=prodarrayUn.getJSONObject(k).getString("id") %>" name="unmatprod" /></td>
								    <td><input type="text" value="<%=prodarrayUn.getJSONObject(k).getString("shortdesc") %>" name="unmatshortdesc" /></td>
								    <td><input type="text" name="unmatchedmetadata" placeholder="enter comma separated value"/></td>
								    </tr>
								    <%} %>
							 ...
							 <h4 class="text-center">Partially Matched Records</h4>
							 	...
							 	<table id="mytable6" class="table table-bordred table-striped table-fixed">
								   ...
								   <% for(int k=0;k<prodarrayPat.length();k++){%>
								    <tr>
								    <td><input type="checkbox" class="checkthis" value="<%=prodarrayPat.getJSONObject(k).getString("id") %>" /></td>
								    <td><input type="text" value="<%=prodarrayPat.getJSONObject(k).getString("category") %>" name="matcat" /></td>
								    <td><input type="text" value="<%=prodarrayPat.getJSONObject(k).getString("id") %>" name="matprod" /></td>
								    <td><input type="text" value="<%=prodarrayPat.getJSONObject(k).getString("shortdesc") %>" name="matshortdesc" /></td>
								    <td><input type="text" name="partmatchedmetadata" placeholder="enter comma separated value"/></td>
								    <td><input type="text" value="<%=prodarrayPat.getJSONObject(k).getString("image") %>" name="matimage" /></td>
								    <td><input type="text" value="<%=prodarrayPat.getJSONObject(k).getString("productname") %>" name="matprodname" /></td>
								    <td><input type="text" value="<%=prodarrayPat.getJSONObject(k).getString("modelnumber") %>" name="matmodelnumber" /></td>
								    <td><input type="text" value="<%=prodarrayPat.getJSONObject(k).getString("companyname") %>" name="matmanu" /></td>
								    </tr>
								<%} %>
								   </tbody>
...
<!--VENDOR tab content starts here-->
							<div id="vendor" class='tab-page tab-pane fade in'>
							 ...
							 <h4 class="text-center">Matched Records</h4>
							 <div style="height: 300px;overflow: auto;">
							 	<table id="mytable7" class="table table-bordred table-striped table-fixed">
					                   
					                   <thead>
					                   
					                   <th><input type="checkbox" id="checkall7" /></th>
					                   <th>Category</th>
					                    <th>Product</th>
					                     <th>ShortDesc</th>
					                     <th>Image</th>
							 ...
							 <h4 class="text-center">Unmatched Records</h4>
							 <div style="height: 300px;overflow: auto;">
							 	<table id="mytable8" class="table table-bordred table-striped table-fixed">
					                   
					                   <thead>
					                   
					                   <th><input type="checkbox" id="checkall8" /></th>
					                   <th>Category</th>
					                    <th>Product Cd</th>
					                     <th>ShortDesc</th>
					                     <th>Additional Metadata</th>
							 ...
							 <h4 class="text-center">Partially Matched Records</h4>
														 <div style="height: 300px;overflow: auto;">
							 	<table id="mytable9" class="table table-bordred table-striped table-fixed">
					                   
					                   <thead>
					                   
					                   <th><input type="checkbox" id="checkall9" /></th>
					                   <th>Category</th>
					                    <th>Product</th>
					                     <th>ShortDesc</th>
					                     <th>Image</th>
