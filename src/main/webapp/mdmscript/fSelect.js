    ...
    $.fn.fSelect = function(options) {
        ...
        fSelect.prototype = {
            create: function() {
                ...
                this.$select.before('<div class="fs-label-wrap"><div class="fs-label" name="'+as+'" id="'+cat+'">' + this.settings.placeholder + '</div><span class="fs-arrow"></span></div>');
